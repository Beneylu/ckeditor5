 ...
 *
 * Note - class name and label are changed from their original special character source
 */
...
import Collection from '../../../ckeditor5-build-classic/node_modules/@ckeditor/ckeditor5-utils/src/collection';
import Model from '../../../ckeditor5-build-classic/node_modules/@ckeditor/ckeditor5-ui/src/model';
import {
	createDropdown,
	addListToDropdown
} from '../../../ckeditor5-build-classic/node_modules/@ckeditor/ckeditor5-ui/src/dropdown/utils';

import FormHeaderView from '../../../ckeditor5-build-classic/node_modules/@ckeditor/ckeditor5-ui/src/formheader/formheaderview';
...
export default class SpecialCharactersNavigationView extends FormHeaderView {
	...
	constructor( locale, groupNames ) {
		...
		this.set( 'class', 'ck-emojis-navigation' );
